...
fun getTypography() = Typography(
    bodyLarge = TextStyle(
        fontFamily = FontFamily(Font(Res.font.Tajawal_Medium)),
...
titleLarge = TextStyle(
    fontFamily = FontFamily(Font(Res.font.Tajawal_Regular)),
...
labelSmall = TextStyle(
    fontFamily = FontFamily(Font(Res.font.Tajawal_Light)),
